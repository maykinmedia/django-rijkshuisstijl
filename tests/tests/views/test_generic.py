...
class FormTestCaseMixin:
    ...
    def test_fields_visible(self):
        response = self.client_get_form(('authors', 'publisher', 'available', 'date_published', 'last_updated', 'stock', 'title'))
...
class TemplateViewTestCase(ViewTestCaseMixin, TestCase):
    ...
    def test_template(self):
        response = self.client_get()
        self.assertTemplateUsed(response, template_name='rijkshuisstijl/views/generic/template.html')

    def test_components(self):
        response = self.client_get()
        self.assertTemplateUsed(response, template_name='rijkshuisstijl/components/textbox/textbox.html')
...
class DetailViewTestCase(ViewTestCaseMixin, TestCase):
    ...
    def test_context_default(self):
        ...
        self.assertEqual(context_key_value_table.get('fields'), ('title', 'authors', 'publisher', 'date_published', 'stock'))
    ...
    def test_components(self):
        response = self.client_get()
        self.assertTemplateUsed(response, template_name='rijkshuisstijl/components/title-header/title-header.html')
        self.assertTemplateUsed(response, template_name='rijkshuisstijl/components/key-value-table/key-value-table.html')
...
class ListViewTestCase(ViewTestCaseMixin, TestCase):
    ...
    def test_context_default(self):
        ...
        self.assertEqual(context.get('columns'), ('title', 'authors', 'publisher', 'date_published', 'stock'))
    ...
    def test_components(self):
        response = self.client_get()
        self.assertTemplateUsed(response, template_name='rijkshuisstijl/components/datagrid/datagrid.html')
