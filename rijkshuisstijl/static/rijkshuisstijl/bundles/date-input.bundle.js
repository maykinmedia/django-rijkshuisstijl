 ...
 */var DateInput=/*#__PURE__*/function(){/**
     ...
     * @return {boolean}
     */},{key:"isDateTime",value:function isDateTime(){return this.node.type==='datetime';}},{key:"updatePlaceholder",value:function updatePlaceholder(){if(!this.node.placeholder){var placeholder=this.getDateFormat().replace('d','dd').replace('m','mm').replace('Y','yyyy');this.node.placeholder=placeholder;}}},{key:"updateClassName",value:function updateClassName(){var parent=this.node.parentElement;var datepicker=parent.querySelector(".input.form-control");datepicker.className="input active";}/**
     * Adds the datepicker.
     */},{key:"update",value:function update(){this.updatePlaceholder();var flatPicker=flatpickr__WEBPACK_IMPORTED_MODULE_1___default()(this.node,{altInput:true,altFormat:this.getDateFormat(),dateFormat:'Y-m-d',defaultDate:this.node.value.split('/'),locale:this.getLocale(),mode:this.getMode()});flatPicker.l10n.rangeSeparator='/';this.updateClassName();}}]);return DateInput;}();// Start!
