(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["toggl-js"],{
 ...
 */var Toggle=/*#__PURE__*/function(){/**
     ...
     *
     * @param {MouseEvent} e
     */},{key:"onClick",value:function onClick(e){var _this=this;var toggleLinkMode=this.node.dataset.toggleLinkMode||'normal';if(toggleLinkMode==='normal'){if(!e.target.getAttribute('href')||e.target.getAttribute('href')==='#'){e.preventDefault();e.stopPropagation();}}else if(toggleLinkMode==='positive'){if(!e.target.href||!this.getState()){e.preventDefault();e.stopPropagation();}}else if(toggleLinkMode==='negative'){if(!e.target.href||this.getState()){e.preventDefault();e.stopPropagation();}}else if(toggleLinkMode==='prevent'){e.preventDefault();e.stopPropagation();}setTimeout(function(){_this.toggle();_this.saveState();_this.focus();},100);}/**
     ...
     */},{key:"toggle",value:function toggle(){var _this2=this;var exp=arguments.length>0&&arguments[0]!==undefined?arguments[0]:undefined;var targets=this.getTargets();targets.forEach(function(target){bem_js__WEBPACK_IMPORTED_MODULE_0___default.a.toggleModifier(target,_this2.toggleModifier,exp);});this.getExclusive().filter(function(exclusive){return targets.indexOf(exclusive)===-1;}).forEach(function(exclusive){return bem_js__WEBPACK_IMPORTED_MODULE_0___default.a.removeModifier(exclusive,_this2.toggleModifier);});}/**
