 ...
 */var Search=/*#__PURE__*/function(){/**
     ...
     */},{key:"onPressEnter",value:function onPressEnter(e){var keyCode=e.keyCode;if(keyCode===13){e.preventDefault();if(this.input.value){window.location="".concat(this.node.action,"?search=").concat(this.input.value);}}}/**
     ...
     */},{key:"onClickButtonPrimary",value:function onClickButtonPrimary(){if(this.input.value){window.location="".concat(this.node.action,"?search=").concat(this.input.value);}if(bem_js__WEBPACK_IMPORTED_MODULE_0___default.a.hasModifier(this.node,_constants__WEBPACK_IMPORTED_MODULE_2__["MODIFIER_OPEN"])){this.input.focus();}else{this.input.blur();}}/**
     * Callback for click event on this.buttonSecondary.
     * Focuses this.input.
     */},{key:"onClickButtonSecondary",value:function onClickButtonSecondary(){this.input.focus();}/**
