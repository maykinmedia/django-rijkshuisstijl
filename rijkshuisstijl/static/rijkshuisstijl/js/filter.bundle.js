 ...
 */var Filter=/*#__PURE__*/function(){/**
     ...
     */},{key:"applyFilter",value:function applyFilter(){var _this=this;setTimeout(function(){var selection=document.querySelectorAll(_this.node.dataset.filterTarget);var query=_this.input.value.toUpperCase();_toConsumableArray(selection).forEach(function(node){bem_js__WEBPACK_IMPORTED_MODULE_0___default.a.addModifier(node,_constants__WEBPACK_IMPORTED_MODULE_1__["MODIFIER_MATCH"]);bem_js__WEBPACK_IMPORTED_MODULE_0___default.a.removeModifier(node,_constants__WEBPACK_IMPORTED_MODULE_1__["MODIFIER_NO_MATCH"]);node.style.removeProperty('display');if(!node.textContent.toUpperCase().match(query)){bem_js__WEBPACK_IMPORTED_MODULE_0___default.a.removeModifier(node,_constants__WEBPACK_IMPORTED_MODULE_1__["MODIFIER_MATCH"]);bem_js__WEBPACK_IMPORTED_MODULE_0___default.a.addModifier(node,_constants__WEBPACK_IMPORTED_MODULE_1__["MODIFIER_NO_MATCH"]);node.style.display='none';}});});}/**
     * Removes display property from inline style of every node matching query selector set in data-filter-target.
     */},{key:"discardFilter",value:function discardFilter(){var selection=document.querySelectorAll(this.node.dataset.filterTarget);_toConsumableArray(selection).forEach(function(node){node.style.removeProperty('display');bem_js__WEBPACK_IMPORTED_MODULE_0___default.a.addModifier(node,_constants__WEBPACK_IMPORTED_MODULE_1__["MODIFIER_MATCH"]);});}}]);return Filter;}();// Start!
