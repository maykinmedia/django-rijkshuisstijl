(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["link-selec-js"],{
 ...
 */var LinkSelect=/*#__PURE__*/function(){/**
     ...
     */_createClass(LinkSelect,[{key:"bindEvents",value:function bindEvents(){var _this=this;this.node.addEventListener('change',function(){location.href=_this.node.value||_this.node.dataset.value;});}}]);return LinkSelect;}();// Start!
